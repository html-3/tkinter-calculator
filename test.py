...
class View(Toplevel):
    def __init__(self, master):
        ...
        Label(self, text='My Money').pack(side='left')
        self.moneyCtrl = Entry(self, width=8)
...
class ChangerWidget(Toplevel):
    def __init__(self, master):
        Toplevel.__init__(self, master)
        self.addButton = Button(self, text='Add', width=8)
        self.addButton.pack(side='left')
        self.removeButton = Button(self, text='Remove', width=8)
...
class Controller:
    def __init__(self, root):
        ...
        self.view2.addButton.config(command=lambda:self.model.addMoney(10))
        self.view2.removeButton.config(command=lambda:self.model.removeMoney(10))
